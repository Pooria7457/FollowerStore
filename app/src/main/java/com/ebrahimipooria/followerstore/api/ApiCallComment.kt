...
class ApiCallComment(var context: Context, var apiCallInterface: ApiCallInterface) {
    ...
    fun saveComment(commentOrderModel: CommentOrderModel){
        apiInterface.saveCommentOrder(commentOrderModel).enqueue(object : Callback<OrderModel>{
